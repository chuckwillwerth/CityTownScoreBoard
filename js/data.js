...
const DIVISIONS = {
  '10U': {
    ...
    subtitle: '8 Teams · Single Elimination · Tufts',
    games: {
      G1:  { id:'G1',  round:'Quarterfinal',  time:'9:00 AM',  field:'Tufts Pool Field',
             team1:'Arlington 10 Stars',        team2:'Charlestown White',
             score1:null, score2:null, winner:null },
      G2:  { id:'G2',  round:'Quarterfinal',  time:'9:00 AM',  field:'Tufts Playground Field',
             team1:'Winchester All Stars',       team2:'Charlestown Columbia',
             score1:null, score2:null, winner:null },
      G5:  { id:'G5',  round:'Quarterfinal',  time:'10:30 AM', field:'Tufts Playground Field',
             team1:'Medford Mustangs',           team2:'Belmont Thunder',
             score1:null, score2:null, winner:null },
      G8:  { id:'G8',  round:'Quarterfinal',  time:'12:30 PM', field:'Tufts Playground Field',
             team1:'Medford Butterflies',        team2:'Everett Mystics',
             score1:null, score2:null, winner:null },
      G11: { id:'G11', round:'Semifinal',      time:'2:00 PM',  field:'Tufts Playground Field',
             team1Source:'G2', team2Source:'G5',
             score1:null, score2:null, winner:null },
      G12: { id:'G12', round:'Semifinal',      time:'4:00 PM',  field:'Tufts Playground Field',
             team1Source:'G8', team2Source:'G1',
             score1:null, score2:null, winner:null },
      G13: { id:'G13', round:'Championship',   time:'5:30 PM',  field:'Tufts Pool Field',
             team1Source:'G12', team2Source:'G11',
             score1:null, score2:null, winner:null },
    },
    ...
    columns: [
      { label:'Quarterfinals',slots:[{ gameId:'G8', flex:1 }, { gameId:'G1', flex:1 }, { gameId:'G2', flex:1 }, { gameId:'G5', flex:1 }] },
      { label:'Semifinals',   slots:[{ gameId:'G12', flex:2 }, { gameId:'G11', flex:2 }] },
      { label:'Championship', slots:[{ gameId:'G13', flex:4 }] },
    ],
  ...
  '12U': {
    ...
    games: {
      G3:  { id:'G3',  round:'Play-In',      time:'10:30 AM', field:'Tufts Parking Lot Field',
             team1:'Cambridge Cardinals',    team2:'Charlestown',
             score1:null, score2:null, winner:null },
      G4:  { id:'G4',  round:'Play-In',      time:'10:30 AM', field:'Tufts Pool Field',
             team1:'Belmont Lightning',       team2:'Boston Base',
             score1:null, score2:null, winner:null },
      G6:  { id:'G6',  round:'Quarterfinal', time:'12:30 PM', field:'Tufts Parking Lot Field',
             team1:'Winchester Red & Black',  team2Source:'G3',
             score1:null, score2:null, winner:null },
      G7:  { id:'G7',  round:'Quarterfinal', time:'12:30 PM', field:'Tufts Pool Field',
             team1:'Watertown',               team2Source:'G4',
             score1:null, score2:null, winner:null },
      G9:  { id:'G9',  round:'Quarterfinal', time:'2:00 PM',  field:'Tufts Parking Lot Field',
             team1:'Everett Rip Tide',        team2:'Medford Butterflies',
             score1:null, score2:null, winner:null },
      G10: { id:'G10', round:'Quarterfinal', time:'2:00 PM',  field:'Tufts Pool Field',
             team1:'Arlington 12 Stars',      team2:'Medford Mustangs',
             score1:null, score2:null, winner:null },
      G14: { id:'G14', round:'Semifinal',    time:'4:00 PM',  field:'Tufts Parking Lot Field',
             team1Source:'G6',  team2Source:'G9',
             score1:null, score2:null, winner:null },
      G15: { id:'G15', round:'Semifinal',    time:'4:00 PM',  field:'Tufts Pool Field',
             team1Source:'G10', team2Source:'G7',
             score1:null, score2:null, winner:null },
      G16: { id:'G16', round:'Championship', time:'5:30 PM',  field:'Tufts Parking Lot Field',
             team1Source:'G14', team2Source:'G15',
             score1:null, score2:null, winner:null },
    },
    columns: [
      { label:'Play-Ins',     slots:[{ gameId:'G3', flex:1 }, { gameId:null, flex:2 }, { gameId:'G4', flex:1 }] },
      { label:'Quarterfinals',slots:[{ gameId:'G6', flex:1 }, { gameId:'G9', flex:1 }, { gameId:'G10', flex:1 }, { gameId:'G7', flex:1 }] },
      { label:'Semifinals',   slots:[{ gameId:'G14', flex:2 }, { gameId:'G15', flex:2 }] },
      { label:'Championship', slots:[{ gameId:'G16', flex:4 }] },
    ],
    connections: [
      ['G3','G6'], ['G4','G7'],
      ['G6','G14'], ['G9','G14'],
